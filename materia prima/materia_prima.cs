...
values (" + row[0].ToString() + @",'" + row[1].ToString() + @"',getdate(),'" + row[3].ToString() + @"','" + row[4].ToString() + @"','" + row[5].ToString() + @"'," + row[6].ToString() + @",'" + row[7].ToString() + @"', convert(datetime,'" + row[8].ToString() + @"',103)" + @", convert(datetime,'" + row[9].ToString() + @"',103),'" + row[10].ToString().Replace(" ", "") + @"','" + fifo + @"'," + idsscc + @"," + _terminal + @",0)";
                    con.sql_update(sql);
                    resultado = true;
                }
                else
